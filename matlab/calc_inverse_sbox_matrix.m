function Inverse_Sbox_ram = calc_inverse_sbox_matrix()
    Inverse_Sbox=[  '52096ad53036a538bf40a39e81f3d7fb'; '7ce339829b2fff87348e4344c4dee9cb';...
    ...
    Inverse_Sbox_matrix_in_rows = reshape(Inverse_Sbox', 2, [])';
    Inverse_Sbox_ram = hex2dec(Inverse_Sbox_matrix_in_rows);
end